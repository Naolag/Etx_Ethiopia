...
export default function Messages() {
  return (
    <div className="bg-[#0B1236] px-4 md:px-20 py-10">
      ...
      <div className="flex flex-col md:flex-row items-center  w-full mx-auto ">
        ...
        >
          ...
          <div className="text-[#f9f70c] font-bold font-mono text-2xl md:text-4xl text-right mt-6">
            H.E. Abiy Ahmed (PhD)
          </div>
          <div className="text-white font-mono text-lg md:text-xl text-right mt-2">
